...
| Managed provider invocation and startup-memory injection | `packages/migrate/manager/src/session-adapters.ts` |
| State roots, provider registry, memory, CLI, packages, and orchestration policy | `packages/migrate/manager/src` |
