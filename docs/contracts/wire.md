...
[`packages/migrate/core/proto/agent_os/v1/`](../../src/migrate/core/proto/agent_os/v1) is
...
> module under [`packages/migrate/core/proto/agent_os/v1/`](../../src/migrate/core/proto/agent_os/v1); this doc is its map.
>
...
bunx --bun @bufbuild/buf lint packages/migrate/core/proto
```
...
|------|--------|---------|-------------|
| **Go** | `packages/migrate/core/contracts-go/gen` | `protocolbuffers/go` + `connectrpc/go` | `connectrpc.com/connect`, `google.golang.org/protobuf` (`go mod tidy`) |
...
| `packages/migrate/core/contracts-go/gen/...` | **buf-generated** | Go message + Connect stubs - regenerate, never hand-edit |
...
|----------|---------------------------------|----------------|------------------------|
| **Go** | `packages/migrate/core/contracts-go` | `agent_osv1 "github.com/marius-patrik/agents-manager/src/migrate/core/contracts-go/gen/agent_os/v1"` | Go services under `packages/migrate/inference/` |
| **Go Connect** | `packages/migrate/core/contracts-go/gen/agent_os/v1/agent_osv1connect` | `import "github.com/marius-patrik/agents-manager/src/migrate/core/contracts-go/gen/agent_os/v1/agent_osv1connect"` | Go services that speak the Connect control plane |
