...
const requiredLayout = [
  ...
  "packages/migrate/agents/.global/skills",
  "packages/migrate/agents/.global/hooks",
  "packages/migrate/agents/.global/roles",
  "packages/migrate/agents/.global/commands",
];
...
const policyFiles = new Set(["packages/scripts/verify-single-product.mjs", ".github/ci/test-inventory.json"]);
...
const expectedJavaScriptWorkspaces = new Map([
  ...
  ["packages/clients/shared-ts/package.json", "@agent-os/shared-ts"],
...
for (const required of ["packages/migrate/manager", "packages/clients/*"]) {
