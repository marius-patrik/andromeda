...
export const DOC_PATHS = ["PRD.md", "AGENTS.md", "packages/migrate/agents/.project/STATUS.md", "packages/migrate/agents/.project/PROJECT.md"];
...
export async function auditManagedFileDrift(github, repository, targetRef, controlRepo = CONTROL_REPO, options = {}) {
  ...
  const releaseControlPaths = new Set([
    ...
    "packages/scripts/df-release.mjs",
...
async function auditProjectOverlay(github, repository, targetRef, agentOsDataRevision) {
  ...
  for (const source of files) {
    ...
    const targetPath = `packages/migrate/agents/.project/${relative}`;
...
export async function auditRepositoryTree(repository, tree, options = {}) {
  ...
  for (const entry of tree.tree) {
    ...
    const allowedProjectAuthority = filePath === ".agents" || filePath === "packages/migrate/agents/.project" || filePath.startsWith("packages/migrate/agents/.project/");
...
export async function auditRetiredAuthorityNames(github, repository, ref) {
  ...
  const authorityPaths = [
    ...
    "PRD.md",
    "AGENTS.md",
    "packages/migrate/agents/.project/AGENTS.md",
    "packages/migrate/agents/.project/COMMANDS.md",
    "packages/migrate/agents/.project/DECISIONS.md",
    "packages/migrate/agents/.project/HANDOFF.md",
    "packages/migrate/agents/.project/PROJECT.md",
    "packages/migrate/agents/.project/STATUS.md",
    "packages/migrate/agents/.project/STRUCTURE.md",
