...
applies `deploy/deploy-release.sh --apply`, and uploads the resulting deploy
...
```bash
deploy/preflight.sh --repo marius-patrik/agents --tag v3.0.0
deploy/preflight.sh --repo marius-patrik/agents --tag v3.0.0 --health
```
